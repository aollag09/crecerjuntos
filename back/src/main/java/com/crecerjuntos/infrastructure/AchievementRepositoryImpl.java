...
public class AchievementRepositoryImpl implements AchievementRepository {
    ...
    public List<Achievement> findByStudent(Long studentId) {
        TypedQuery<Achievement> q = em.createQuery("SELECT a FROM Achievement a WHERE student_id = ?studentId", Achievement.class);
    ...
    public List<Achievement> findDoneByStudent(Long studentId) {
        TypedQuery<Achievement> q = em.createQuery("SELECT a FROM Achievement a WHERE student_id = ?studentId AND progress >= 100", Achievement.class);
        q.setParameter("studentId", studentId);
        return q.getResultList();
    }
    ...
    public List<Achievement> findLastsByStudent(Long studentId, int nbAchievements) {
        TypedQuery<Achievement> q = em.createQuery("SELECT a FROM Achievement a WHERE student_id = ?studentId ORDER BY timestamp DESC", Achievement.class);
        q.setParameter("studentId", studentId);
    ...
    public List<Achievement> findBySection(Long sectionId) {
        TypedQuery<Achievement> q = em.createQuery("SELECT a FROM Achievement a WHERE section_id = ?sectionId", Achievement.class);
    ...
    public List<Achievement> findLastsBySection(Long sectionId, int nbAchievements) {
        TypedQuery<Achievement> q = em.createQuery("SELECT a FROM Achievement a WHERE student_id = ?sectionId ORDER BY timestamp DESC", Achievement.class);
        q.setParameter("sectionId", sectionId);
        return q.getResultList().subList(0, nbAchievements);
    }
