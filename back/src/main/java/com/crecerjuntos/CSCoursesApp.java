...
public class CSCoursesApp implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    logger.info(
        "Registering aceleracion-> {}", sectionRepository.save(new Section(1L, "Aceleracion")));
    ...
    logger.info(
        "Registering proceso basico-> {}",
        sectionRepository.save(new Section(10L, "Proceso Basico")));
  }
}
